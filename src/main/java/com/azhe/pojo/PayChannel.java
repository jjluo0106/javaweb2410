...
public class PayChannel {
    ...
    private String orderNum;               // 支付通道排序字段
    ...
    private String totalLoadTimes;         // 累计充值次数
